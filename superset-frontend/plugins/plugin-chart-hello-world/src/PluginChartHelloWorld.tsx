...
import { PluginChartHelloWorldProps, PluginChartHelloWorldStylesProps } from './types';
...
export default function PluginChartHelloWorld(props: PluginChartHelloWorldProps) {
